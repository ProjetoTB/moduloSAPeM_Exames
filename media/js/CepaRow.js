	...
	var content = ($('<tr>')
		...
		.append($('<td />')
			.append($('<select /> ')
				...
				.append($('<option> Instituto de Pesquisa Clínica Evandro Chagas/ Fiocruz - IPEC </option>')
					.attr('value', 'institutoDePesquisaClinicaEvandroChagas_Fiocruz_IPEC')
				)
				.append($('<option> Centro de referência Prof. H.F.F - CRPHFF </option>')
					.attr('value', 'centroDeReferenciaProfHFF_CRPHFF')
				)
				.append($('<option> Científica Lab.- RJ </option>')
					.attr('value', 'cientificaLab_RJ')
				)
				.append($('<option> Hospital Messejana - CE </option>')
					.attr('value', 'hospitalMessejana_CE')
				)
				.append($('<option> Lacen - CE </option>')
					.attr('value', 'lacen_CE')
				)
				.append($('<option> Instituto Clemente Ferreira - SP </option>')
					.attr('value', 'institutoClementeFerreira_SP')
				)
				.append($('<option> Adolfo Lutz - SP </option>')
					.attr('value', 'adolfoLutz_SP')
				)
			)
			.attr('rowspan', '6')
		)
